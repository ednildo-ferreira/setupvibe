...
- `desktop.ps1` — native x64 Windows 11 22H2+ (Beta); Windows utilities, Python 3.14, Node.js LTS, and the WSL 2 base without a Linux distribution, frameworks, runtime managers, or AI CLIs

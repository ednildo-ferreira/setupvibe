...
Cross-platform setup for macOS and Linux desktops. Installs a complete development stack in one command: PHP 8.5, Ruby 3.4.10, Go 1.26.5, Rust, Python, Node.js 24 LTS, DevOps tools, modern Unix utilities, shell, tmux, AI CLI tools, and the Vercel Labs Skills CLI.

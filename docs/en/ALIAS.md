...
> Shell environment aliases — v0.41.10
...
- **`ssh_copy_id`**
  - Availability: 🌐 Both
  - Command: `~/.setupvibe/bin/ssh_copy_id --host HOST --user USER [--pass PASS]`
  ...
  - Example: `ssh_copy_id --host 192.0.2.10 --user root --pass 'secret'`

...
- Derniers client et serveur Microsoft Win32-OpenSSH officiels via le MSI officiel
...
5. Force l'installation des derniers client et serveur Microsoft Win32-OpenSSH officiels via le MSI officiel, configure le `PATH` de la machine, valide `ssh.exe -V`, démarre automatiquement `sshd` et autorise le trafic TCP/22 entrant.
...
12. Configure Starship et zoxide pour Windows PowerShell et PowerShell 7.

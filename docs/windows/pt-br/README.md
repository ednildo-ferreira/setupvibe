...
A Edição Windows (Beta) configura utilitários nativos do Windows, Python e Node.js, usando o WinGet como fonte principal e o Chocolatey para pacotes indisponíveis no WinGet.
